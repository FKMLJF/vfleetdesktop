        ...
        $(document).ready(function () {
            ...
            $(function () {
                var table = $('#autok_table').DataTable({
                    ...
                    buttons: [
                        {
                            text: '<i class="fa fa-plus text-white" style="font-size: 16px" title="Új termény hozzáadása."></i>',
                        ...
                        {
                            text: '<i class="fa fa-edit text-white" style="font-size: 16px" aria-hidden="true" title="Termény módosítása"></i>',
